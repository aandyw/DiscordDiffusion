const { SlashCommandBuilder, AttachmentBuilder, ActionRowBuilder, ButtonBuilder, ButtonStyle, Message, ComponentType} = require("discord.js");
...
module.exports = {
	data: new SlashCommandBuilder()
		...
		.addStringOption(option =>
			option.setName('prompt')
				.setDescription('Used for sticker generation')),
	async execute(interaction) {
		...
		const row = new ActionRowBuilder()
			.addComponents(topLeft, topRight, bottomLeft, bottomRight, regenerate);
